...
def start_recording(filename, frame_size):
    create_save_folder()
    global video_out
    video_out = cv.VideoWriter(filename, cv.VideoWriter_fourcc(*'MJPG'), 20.0, frame_size)
...
def main():
    ...
    while True:   
        ...
        global sobel_wait_selecting
        global is_sobel_filter_X
        global is_sobel_filter_Y
        global sobel_kernel_size
        global is_canny_edge_detection
        global is_object_detection, sift, search_img, nFeatures
        sift_brute_img = None
